...
MEMORY
{
    PAGE 0 :
        ...
        HSARAM1         : origin = 0x3f8000, length = 0x001000      /* RAM */
    ...
    PAGE 1 : 
        HSARAM2         : origin = 0x3f9000, length = 0x001000      /* RAM */
...
SECTIONS
{
    ...
    .switch             : > FLASH,          PAGE = 0
    .stack              : > MSARAM,         PAGE = 1
    .esysmem            : > MSARAM,         PAGE = 1 /* TODO: fix */
    .cio                : > LSARAM,         PAGE = 1
    .ebss               : > LSARAM,         PAGE = 1
    OtherBss            : section 
                            { 
                                Bin\Hw\HwUart.obj(.ebss)    /* Large firmware buffers go here */
                                Bin\Hw\HwCodec.obj(.ebss) 
                                Bin\Hw\ViterbiDecoder.obj(.ebss)
                            } > HSARAM2, PAGE = 1

    CodeEntry           : > FLASH_ENTRY,    PAGE = 0
